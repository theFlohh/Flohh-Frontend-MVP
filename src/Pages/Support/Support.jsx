...
import { sendSupportMessage } from "../../Services/Api"; // <-- apni API file ka path adjust karo
      ...
      <div className="max-w-6xl mx-auto py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Need help? We're here to assist you. Get in touch with our support
              ...
              <div className="space-y-4 text-gray-300">
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    ...
                    All communications are secured with industry-standard
                    encryption.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    ...
                    We protect your privacy and handle data according to GDPR
                    regulations.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    ...
                    Our security management system meets international
                    standards.
                  </p>
                </div>
              </div>
