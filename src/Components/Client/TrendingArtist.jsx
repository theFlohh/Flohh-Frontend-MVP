  ...
  return (
    <section className="bg-gray-50 rounded-xl p-6 shadow mb-8">
      <div className="flex items-center justify-between mb-2">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
            Trending Artists <span role="img" aria-label="fire">🔥</span>
          </h2>
      ...
      <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
        {artists.length === 0 ? (
          <div className="text-gray-400 text-center w-full">No trending artists found.</div>
        ) : (
          artists.map((artist) => (
            <div
            ...
            >
              ...
              <img
                src={artist.img || artist.image || "https://randomuser.me/api/portraits/men/32.jpg"}
                alt={artist.name}
