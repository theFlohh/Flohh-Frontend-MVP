      ...
      <div>
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          <div className="flex items-center gap-2 bg-gray-50 rounded-full px-4 py-2 text-gray-800 text-base font-medium">
            ...
            {bestPlatform || 'N/A'} : <span className="font-bold">{(bestPlatformScore)}</span>
          </div>
          <div className="flex items-center gap-2 bg-gray-50 rounded-full px-4 py-2 text-gray-800 text-base font-medium">
            ...
            Rank : <span className="font-bold"># {rank} Out of {outOf}</span>
          </div>
        </div>
        <div className="flex items-center gap-2 bg-gray-50 rounded-full px-4 py-2 text-gray-800 text-base font-medium w-fit">
          ...
          Best Platform : <span className="font-bold">{mostViewedPlatform || 'N/A'}</span>
        </div>
      </div>
      {/* Follow On */}
      <div className="mt-4">
        ...
        <div className="flex gap-4">
          ...
          {artist?.youtubeChannelId && <a href={`https://youtube.com/channel/${artist.youtubeChannelId}`} className="bg-red-100 hover:bg-red-200 rounded-full p-2" target="_blank" rel="noopener noreferrer"><img src="/img/logos_youtube-icon.png" alt="YouTube" className="w-6 h-6" /></a>}
          ...
          {artist?.chartmetricId && <a href={`https://app.chartmetric.com/artist/${artist.chartmetricId}`} className="bg-gray-100 hover:bg-gray-200 rounded-full p-2" target="_blank" rel="noopener noreferrer"><img src="/img/chartmetric.png" alt="Chartmetric" className="w-6 h-6" /></a>}
